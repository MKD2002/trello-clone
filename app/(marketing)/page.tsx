...
const textFont = Poppins({
    subsets: ['latin'],
    weight: [
        "100", "200", "400", "300", "500", "600", "700", "800", "900"
    ]
})
    ...
    return (
        <div className="flex items-center justify-center flex-col">
            <div className={cn(
                ...
                <div className="text-3xl md:text-6xl  bg-gradient-to-r from-fuchsia-600 to-pink-600 text-white px-6 p-4 rounded-md pb-3 w-fit">
                    work forward.
                </div>
            </div>
            <div className={cn(
